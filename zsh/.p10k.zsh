# Generated by Powerlevel10k configuration wizard on 2025-06-27 at 00:18 CEST.
...
() {
  ...
  # typeset -g POWERLEVEL9K_VCS_GIT_GITHUB_ICON='' # dev
  # typeset -g POWERLEVEL9K_VCS_GIT_GITHUB_ICON='' # fa
  # typeset -g POWERLEVEL9K_VCS_GIT_GITHUB_ICON='󰊤' # md
  # typeset -g POWERLEVEL9K_VCS_GIT_GITHUB_ICON='' # seti
  # typeset -g POWERLEVEL9K_VCS_GIT_GITHUB_ICON='' # cod-inverted
  # typeset -g POWERLEVEL9K_VCS_GIT_GITHUB_ICON='' # dev-badge
